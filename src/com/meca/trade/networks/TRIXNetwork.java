...
public class TRIXNetwork extends Network {
	...
	@Override
	  protected void define() {
	    ...
	    connect(component("_QuotePrice_C"), port("OUT",3), component("_TRIX"), port("INPUT"));
	    ...
	    connect(component("_TRIX"), port("TRIX"), component("_TradeMultiplexer"), port("IN",6));
	    connect(component("_TRIX"), port("SIGNALLINE"), component("_TradeMultiplexer"), port("IN",7));
